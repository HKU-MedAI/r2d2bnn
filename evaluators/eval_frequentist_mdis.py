...
class FrequentistMdisEvaluator(Evaluator):
    ...
    def compute_mdists(self, idx, args):
        ...
        m_dist = tester.rht(lamb, mu, test_mu, n_1, n_2, p).item()
        return m_dist
    ...
    def test_one_step(self, test_embs, posterior):
        ...
        v_func = np.vectorize(self.compute_mdists)
